---
profile:
  name: dev-local-docker
  version: 1.0.0
  description: Local development profile with OpenAI provider for Docker environments (uses absolute paths)

session:
  orchestrator:
    module: orchestrator-coding
    source: /tmp/agent_source/amplifier-module-orchestrator-coding
    config:
      max_iterations: 100
  context:
    module: context-coding
    source: /tmp/agent_source/amplifier-module-context-coding
...
providers:
  - module: provider-openai-v2
    source: /tmp/agent_source/amplifier-module-provider-openai-v2
    config:
      use_azure: false
      model: gpt-5.1-codex
...
tools:
  ...
  - module: tool-todo
    source: /tmp/agent_source/amplifier-module-tool-todo
  - module: tool-bash
    source: /tmp/agent_source/amplifier-module-tool-bash
